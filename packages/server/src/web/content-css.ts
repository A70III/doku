/**
 * CSS ชั้นเนื้อหาเอกสาร (.doku-prose + token) — serve ที่ `/static/content.css`
 *
 * ขอบเขต M1: ย้ายมาจาก preview ของ CLI (M0) เป็นชุดเดียวกัน — ตัดส่วน chrome ของ
 * หน้า preview ออก (การ์ด/footer ของเว็บแอปใช้ Tailwind แทน)
 * M2 จะ restructure เป็น tokens.css / prose.css / blocks.css ตาม docs/03 §10
 */
...
/* ── prose layer (เนื้อหาเอกสาร — ห้ามใช้ Tailwind โดยเจตนา) ───────────────── */
